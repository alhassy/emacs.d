...
- [[#org-mode-administrivia][Org-Mode Administrivia]]
  ...
  - [[#org-modes-𝒳-block-expansions][Org-mode's <𝒳 Block Expansions]]
    - [[#todo-demoing-dot-graphs][TODO Demoing Dot Graphs]]
- [[#org-mode--pdf--html][Org-Mode ⇒ PDF & HTML]]
  ...
  - [[#httpsrevealjscomtransitionzoomrevealjs----the-html-presentation-framework][Reveal.JS -- The HTML Presentation Framework]]
...
- [[#life-within-org-mode][Life within Org-mode]]
  ...
  - [[#automating-httpsenwikipediaorgwikipomodoro_techniquepomodoro----commit-for-only-25-minutes][Automating Pomodoro ---“Commit for only 25 minutes!”]]
...
- [[#programming][Programming]]
  ...
  - [[#text-folding-with-httpsgithubcomgregsextonorigamielorigami-mode][Text Folding with Origami-mode]]
