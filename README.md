...
1.  [Abstract](#org85c597f):ignore:
2.  [Why Emacs?](#org048d2e6)
3.  [Booting Up](#orge5e0227)
    1.  [`~/.emacs` vs. `init.org`](#orge74e839)
    2.  [Elementary Version Control](#org3c7015c)
    3.  [What's in, or at the top of, my `~/.emacs`](#orgf295542)
    4.  [`use-package` &#x2013;The start of `init.el`](#org5b7c631)
    5.  [`magit` &#x2013;Emacs' porcelain interface to git](#org29c2a80)
    6.  [Fix spelling as you type &#x2013;and a thesaurus too!](#orge125262)
    7.  [Unicode Input via Agda Input](#org908cae7)
    8.  [Locally `toggle` a variable](#orged0b452)
    9.  [Syncing to the System's `$PATH`](#orgdc8ac4e)
    10. [Who am I?](#org33dd66e)
4.  [Cosmetics](#orgdac5a20)
    1.  [Startup message: Emacs & Org versions](#org74da0e7)
    2.  [Spaceline: A sleek mode line](#org03638fe)
    3.  [Flashing when something goes wrong](#org8608ff9)
    4.  [My to-do list: The initial buffer when Emacs opens up](#org303f34a)
    5.  [Showing date, time, and battery life](#orgd0d73f1)
    6.  [Hiding Scrollbar, tool bar, and menu](#orgdf1bc08)
    7.  [Increase/decrease text size and word wrapping](#org66e276a)
    8.  [Delete Selection mode](#orgfd15dc8)
    9.  [Highlight & complete parenthesis pair when cursor is near ;-](#orgfd9b5fe)
    10. [Minibuffer should display line and column numbers](#orgfd9ea6d)
    11. [Neotree: Directory Tree Listing](#org98ccbf0)
    12. [Window resizing using the golden ratio](#org02918fc):Disabled:
5.  [Life within Org-mode](#org845be6c)
    1.  [Org Speed Keys](#org5f95128)
    2.  [Using org-mode as a Day Planner](#org407ecaf)
    3.  [Workflow States](#WorkflowStates)
    4.  [Clocking Work Time](#org97144b8)
    5.  [Coloured LaTeX using Minted](#orgc17c318)
    6.  [Editing & Special Key Handling](#org7c5c3fd)
    7.  [Executing code from `src` blocks](#orgb7da333)
    8.  [Hiding Emphasise Markers & Inlining Images](#org2e448ce)
    9.  [Jumping without hassle](#orgfdad80d)
    10. [Folding within a subtree](#org3e1002c)
    11. [Making then opening html's from org's](#org8ddb5ab)
    12. [Making then opening pdf's from org's](#org8bb50c1)
    13. [Interpret the Haskell source blocks in a file](#orgf13426f)
6.  [Expected IDE Support](#org17b0c90)
    1.  [Backups](#orgb51fd38)
    2.  [Snippets &#x2013; Template Expansion](#org4e8c8b0)
    3.  [Mouse Editing Support](#org7fb7861)
    4.  [Having a workspace manager in Emacs](#orgf535527)
    5.  [Completion Frameworks](#orgb560183)
    6.  [Jump between windows using Cmd+Arrow](#org8bdd2d9)
7.  [Helpful Functions & Shortcuts](#org7a0d766)
    1.  [Bind `recompile` to `C-c C-m` &#x2013; “m” for “m”ake](#orgfd800eb)
    2.  [Reload buffer with `f5`](#orga1d0e5e)
    3.  [Kill to start of line](#orgeeb43f7)
    4.  [`file-as-list` and `file-as-string`](#org7d72d40)
    5.  [`kill-other-buffers`](#org503bf1a)
    6.  [`create-scratch-buffer`](#org77ffb6b)
    7.  [Switching from 2 horizontal windows to 2 vertical windows](#org605f433)
    8.  [`re-replace-in-file`](#orgeaf9ea4)
    9.  [Obtaining Values of `#+KEYWORD` Annotations](#org4ac3470)
    10. [Quickly pop-up a terminal, run a command, close it](#orgcdd7fe3)
    11. [`C-x k` kills current buffer](#org845da71)
8.  [Summary of Utilities Provided](#org613b409)
...
[5.3](#WorkflowStates) and contain states: `TODO, STARTED, WAITING, ON_HOLD, CANCELLED, DONE`.
...
1.  Org-mode Templates &#x2013;A reason I “generate” templates ;)
    ...
    Whence,
        ...
        (cl-defun make-lang-template (key lang)
    ...
    `s-`, due to company mode, brings up a list of languages
