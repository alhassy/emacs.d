...
(cl-defun my/make/org-capture-template 
   (shortcut description heading category &optional (todo ""))
...
(setq org-capture-templates
  `(
     ,(my/make/org-capture-template "i" 
         "Important tasks that need to be tackled; e.g., research." 
         "Todo Important Tasks" 
         "Research")

     ,(my/make/org-capture-template "r" "Respond to an email" "Todo Email" "Email")
     ,(my/make/org-capture-template "e" "Notes related to Emacs (•̀ᴗ•́)و" "Emacs" "Fun")
     ,(my/make/org-capture-template "b" "Notes related to my personal blog" "Blog" "Fun")
     ,(my/make/org-capture-template "l" "Stuff to eventually read and learn" "Reading and Learning" "Fun")

     ,(my/make/org-capture-template "t" "Arbitrary tasks"
       "Tasks, Getting Things Done" "GTD, Refile" "TODO")
))
#+end_src
