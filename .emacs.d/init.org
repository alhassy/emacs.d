...
This is a [[https://www.offerzen.com/blog/literate-programming-empower-your-writing-with-emacs-org-mode][literate program]] file.
#+END_CENTER

#+NAME: Some front matter for resulting elisp file.
#+HTML: <!-- 
...
#+BEGIN_SRC emacs-lisp :tangle "~/tmp/delme"
...
Soft links are pointers to other filenames, whereas hardlinks
are pointers to memory location of a given filename!

Soft links are preferably since they defer to the orginal filename
...
You may need to unlink softlinks if you already have them;
e.g., ~unlink .emacs.d~.
...
**** haskell setups
  ...
  ;; (require 'mmm-auto)
  ;; (add-hook 'literate-haskell-mode 'my-mmm-mode) ;; WTF THiS DOESN'T WORK!!!
  ;; (defun my-mmm-mode ()
...
#+END_SRC
* Cosmetics
** COMMENT Column Marker                            :not_working_as_desired:
...
* COMMENT abbrev-mode                                        :no_longer_used:
#+BEGIN_SRC emacs-lisp
