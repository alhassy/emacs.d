...
formats --html, latex, pdf, etc-- from a single source, keeping track of [[https://orgmode.org/worg/org-tutorials/index.html#orgff7b885][schedules]], blogging, habit tracking, personal information management tool, and [[http://orgmode.org/worg/org-contrib/][much more]].
...
(defun my/make/org-capture-template (shortcut description heading)
...
(setq org-capture-templates
  `(
     ,(my/make/org-capture-template "f" "Todos needing less than 5 minutes" "Five-Minutes Tasks \n #+CATEGORY: Getting Things Done")
     ,(my/make/org-capture-template "t" "Important tasks that need to be tackled; e.g., research." "Todo Important Tasks \n #+CATEGORY: Research")
     ,(my/make/org-capture-template "r" "Respond to an email" "Todo Email \n #+CATEGORY: Email")
     ,(my/make/org-capture-template "e" "Notes related to Emacs (•̀ᴗ•́)و" "Emacs \n #+CATEGORY: Fun")
     ,(my/make/org-capture-template "b" "Notes related to my personal blog" "Blog \n #+CATEGORY: Fun")
     ,(my/make/org-capture-template "l" "Stuff to eventually read and learn" "Reading and Learning \n #+CATEGORY: Fun")

     ;; Such a clutter is a terrible idea, hopefully I will have more tags in time.
     ,(my/make/org-capture-template "a" "Arbitrary ideas and notes (─‿‿─)" "Random Org-Capture Notes \n #+CATEGORY: Need to Refile")
))
#+end_src
...
The next day we begin our work, we 
press ~C-c a a~ to see the scheduled tasks for this week --~C-c C-s~ to re-schedule the task under the cursor and ~r~ to refresh the agenda.
#+begin_src emacs-lisp
...
+ Clock in :: on a heading with ~C-c C-x C-i~.
+ Clock out :: of a heading with ~C-c C-x C-o~.
