...
* Top matter ─ FIXME need to integrate with my “loads” from below here
...
;; Useful since I symlink my .emacs ;-)
;;
...
;; Get org-headers to look pretty! https://github.com/emacsorphanage/org-bullets
(use-package org-bullets :ensure t)
(add-hook 'org-mode-hook 'org-bullets-mode)
#+END_SRC
We now invoke ~(use-package XYZ :ensure t)~
which should check for the XYZ package and make sure it is accessible. 
If not, the ~:ensure t~ part tells use-package to download it and place 
it somewhere accessible, in ~~/.emacs.d/elpa/~ by default.
...
Edit: Recently I switched to spacemacs. I know nothing about spacemacs, I'm just trying it out now
and so something below are likely to be super wrong
--but they work for me, for now.
...
wrapped in a layer.
(describe-symbol 'dotspacemacs-additional-packages)
#+BEGIN_SRC emacs-lisp
...
(use-package magit   :ensure t)     ;; Efficient version control.
...
#+BEGIN_SRC emacs-lisp
;; For example, I have my "show recent files pop-up" set to C-x C-r;
...
#+BEGIN_SRC emacs-lisp
(setq inhibit-startup-message t) ;; duplicated?
...
#+END_SRC
* TODO Helpful Functions & Shortcuts
...
** COMMENT Kill to start of line
Dual to ~C-k~,
#+BEGIN_SRC emacs-lisp
;; M-k kills to the left
(global-set-key "\M-k" '(lambda () (interactive) (kill-line 0)) )
#+END_SRC
** COMMENT ~file-as-list~ and ~file-as-string~
...
#+END_SRC
** COMMENT Switching from 2 horizontal windows to 2 vertical windows
...
#+END_SRC
** COMMENT Locally ~toggle~ a variable
...
** COMMENT Obtaining Values of ~#+KEYWORD~ Annotations
...
** COMMENT Neotree: Directory Tree Listing
